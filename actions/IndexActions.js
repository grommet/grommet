...
function get(url, params, action, context) {
  Rest.get(url, normalizeParams(params)).end(function (err, res) {
    if (res.status === 400) {
      return Actions.logout();
    }
    if (err || !res.ok) {
...
IndexActions.getItems.listen(function (params, watch, replaceRequest) {
  getOrWatch('/rest/index/resources', params, this, params, watch, replaceRequest);
});

IndexActions.getAggregate.listen(function (params, watch, replaceRequest) {
  getOrWatch('/rest/index/resources/aggregated', params, this, params, watch, replaceRequest);
});

IndexActions.getMap.listen(function (uri, watch, replaceRequest) {
  getOrWatch('/rest/index/trees/aggregated' + uri, null, this, uri, watch, replaceRequest);
});
