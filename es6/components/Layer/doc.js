...
export var doc = function doc(Layer) {
  ...
  DocumentedLayer.propTypes = {
    ...
    animation: PropTypes.oneOfType([PropTypes.oneOf(['slide', 'fadeIn', 'none']), PropTypes.bool]).description('Animation transition of the Layer content when it opens.').defaultValue('slide'),
