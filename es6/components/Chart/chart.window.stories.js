...
import { generateData } from './story-data'; // compress data for outer control chart
...
function (_Component) {
  ...
  function WindowChart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (range) {
      _this.setState({
        range: range
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onHover", function (value) {
