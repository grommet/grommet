...
import { getSectionKeyFromType, getSectionNameFromType, getSectionTokenFromType } from '../../utils/sectionHelpers';
import { StyledDateTimeInput, StyledDateTimeInputContainer, StyledDateTimeInputDisplay, StyledDateTimeInputField, StyledDateTimeInputSegment, StyledDateTimeInputSeparator } from './StyledDateTimeInput';
...
var getSeededTimeSections = function getSeededTimeSections(sections, format, showSeconds) {
  ...
  var hourMin = defaultHourForFormat(format);
  return _extends({
...
var formatSectionText = function formatSectionText(section, value) {
  if (value === undefined || value === '') return getSectionTokenFromType(sectionTypeFromSection(section));
...
var DateTimeInput = /*#__PURE__*/forwardRef(function (_ref, refArg) {
  ...
  var resolvedFormat = useMemo(function () {
  ...
  var activeSectionRef = useRef(SECTION_DAY);
  var suppressSegmentFocusRef = useRef(false);
  var suppressTimePartialSyncRef = useRef(false);
  ...
  var commitSections = useCallback(function (nextSections) {
    ...
    var complete = sectionOrder.every(function (section) {
      return nextSections[getSectionKeyFromType(sectionTypeFromSection(section))] !== undefined;
    });
  ...
  var commitPendingBuffer = useCallback(function () {
  ...
  var applyDigit = useCallback(function (digit) {
    ...
    var key = getSectionKeyFromType(sectionTypeFromSection(activeSection));
  ...
  var getDisplayText = useCallback(function (section) {
    var key = getSectionKeyFromType(sectionTypeFromSection(section));
  ...
  var sectionValueAnnouncement = useCallback(function (section) {
  ...
  var handleCalendarSelect = useCallback(function (nextDateValue) {
  ...
  var handleTimeSelect = useCallback(function (_ref3) {
  ...
  var TIME_TO_DT_SECTION = useMemo(function () {
    return [SECTION_HOUR, SECTION_MINUTE, SECTION_SECOND, SECTION_PERIOD];
  }, []);
  var handleTimePartialChange = useCallback(function (timeSections, changedTimeSectionIndex) {
  ...
  return /*#__PURE__*/React.createElement(Keyboard, {
  ...
  }, passThemeFlag), /*#__PURE__*/React.createElement(StyledDateTimeInputField, passThemeFlag, /*#__PURE__*/React.createElement(StyledDateTimeInputDisplay, _extends({
    role: "group",
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      key: section
    }, !!prefix && /*#__PURE__*/React.createElement(StyledDateTimeInputSeparator, _extends({
      $filled: hasDisplayValue,
      $paddingInline: dateTimeSeparatorPadding
    }, passThemeFlag), prefix), /*#__PURE__*/React.createElement(StyledDateTimeInputSegment, _extends({
  ...
  })), /*#__PURE__*/React.createElement(StyledDateTimeInput, _extends({
    tabIndex: -1
  }, rest, {
    id: id,
    ref: inputRef,
