...
export var StyledWizardMiddle = styled.div.withConfig(styledComponentsConfig).withConfig({
...
// fall through as-is.
export var StyledWizardCenter = styled.div.withConfig(styledComponentsConfig).withConfig({
...
export var StyledWizardBody = styled.div.withConfig(styledComponentsConfig).withConfig({
...
export var StyledWizardContentColumn = styled.div.withConfig(styledComponentsConfig).withConfig({
