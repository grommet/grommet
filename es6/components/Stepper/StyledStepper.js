...
var StyledIndicator = styled.span.withConfig(styledComponentsConfig).withConfig({
  ...
  var defaultColorHoverColor = color ? "color-mix(in srgb, " + color + " 80%, black)" : normalizeColor(((_theme$stepper6 = theme.stepper) == null || (_theme$stepper6 = _theme$stepper6.hover) == null ? void 0 : _theme$stepper6.color) || 'text-strong', theme);
