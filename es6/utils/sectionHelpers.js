...
export var getSectionKeyFromType = function getSectionKeyFromType(sectionType) {
  return sectionKeyByType[sectionType];
};
export var getSectionTokenFromType = function getSectionTokenFromType(sectionType) {
  return sectionTokenByType[sectionType];
};
export var getSectionNameFromType = function getSectionNameFromType(_ref) {
