...
var lineCommands = exports.lineCommands = function lineCommands(centerX, centerY, radius, angle) {
...
var calcAngle = exports.calcAngle = function calcAngle(radius, angle, midAngle, gap) {
  if (gap === 0) {
    return angle;
  }
...
var wedgeCommands = exports.wedgeCommands = function wedgeCommands(centerX, centerY, outerRadius, innerRadius, startAngle, endAngle, startGap, endGap, startRound, endRound, startRoundDirection) {
