...
var doc = function doc(TableCell) {
  ...
  DocumentedTableCell.propTypes = {
    plain: _reactDesc.PropTypes.oneOfType([_reactDesc.PropTypes.bool, _reactDesc.PropTypes.oneOf(['noPad'])]).description("Whether default styling context should be removed.").defaultValue(false),
