...
var _excluded = ["a11yTitle", "aria-label", "children", "disabled", "dropAlign", "dropBackground", "dropProps", "dropTarget", "justifyContent", "icon", "items", "label", "messages", "onKeyDown", "open", "plain", "size"],
  _excluded2 = ["align"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
...
var Menu = exports.Menu = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var iconDisabledColor = (0, _utils.normalizeColor)(((_theme$menu$disabled = theme.menu.disabled) == null || (_theme$menu$disabled = _theme$menu$disabled.icons) == null ? void 0 : _theme$menu$disabled.color) || theme.menu.icons.color || 'control', theme);
