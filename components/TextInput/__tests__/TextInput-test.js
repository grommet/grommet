...
describe('TextInput', function () {
  ...
  test('complex suggestions', function (done) {
    var _render4 = (0, _react2.render)(_react["default"].createElement(_Grommet.Grommet, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: [{
  ...
  test('close suggestion drop', function (done) {
    var _render5 = (0, _react2.render)(_react["default"].createElement(_Grommet.Grommet, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: ['test', 'test1']
  ...
  test('let escape events propagage if there are no suggestions', function (done) {
    ...
    var _render6 = (0, _react2.render)(_react["default"].createElement(_Grommet.Grommet, null, _react["default"].createElement(_Keyboard.Keyboard, {
      onEsc: callback
  ...
  test('select a suggestion', function () {
    ...
    var _render8 = (0, _react2.render)(_react["default"].createElement(_Grommet.Grommet, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: ['test', {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            onSelect = jest.fn();
            _render11 = (0, _react2.render)(_react["default"].createElement(_Grommet.Grommet, null, _react["default"].createElement(_.TextInput, {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            onSelect = jest.fn();
            _render12 = (0, _react2.render)(_react["default"].createElement(_Grommet.Grommet, null, _react["default"].createElement(_.TextInput, {
              "data-testid": "test-input-focus",
              id: "input-focus",
              name: "input-focus",
              placeholder: "Type to search...",
