...
var StyledDiagram = exports.StyledDiagram = _styledComponents["default"].svg.withConfig(_styles.styledComponentsConfig).attrs(_defaultProps.withTheme).withConfig({
