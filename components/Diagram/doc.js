...
var animationPropType = _reactDesc.PropTypes.oneOfType([_reactDesc.PropTypes.bool, _reactDesc.PropTypes.oneOf(['pulse', 'draw']), _reactDesc.PropTypes.shape({
  type: _reactDesc.PropTypes.oneOf(['pulse', 'draw']),
  delay: _reactDesc.PropTypes.oneOfType([_reactDesc.PropTypes.number, _reactDesc.PropTypes.string]),
  duration: _reactDesc.PropTypes.oneOfType([_reactDesc.PropTypes.number, _reactDesc.PropTypes.string]),
  size: _reactDesc.PropTypes.oneOf(['xsmall', 'small', 'medium', 'large', 'xlarge']).description('Size is only applicable when using "pulse"')
})]);
