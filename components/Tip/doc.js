...
var doc = function doc(Tip) {
  var DocumentedTip = (0, _reactDesc.describe)(Tip).availableAt((0, _mixins.getAvailableAtBadge)('Tip')).description("Tooltip or a hint when hovering over a UI item. \n    The tooltip will render when hovering on top of the \n    Tip child node or string.").usage("import { Tip } from 'grommet';\n<Tip />");
