...
var StyledParagraph = exports.StyledParagraph = _styledComponents["default"].p.withConfig(_utils.styledComponentsConfig).attrs(_defaultProps.withTheme).withConfig({
