  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      if (this.props.icon) {
        ...
        if (!CustomIcon) {
          console.warn('Warning: Button is unable to find the icon named ' + this.props.icon);
        } else {
