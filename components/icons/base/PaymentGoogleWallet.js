...
var Icon = function (_Component) {
  ...
  (0, _createClass3.default)(Icon, [{
    ...
    value: function render() {
      ...
      a11yTitle = a11yTitle || _Intl2.default.getMessage(intl, 'payment-google-wallet');

      return _react2.default.createElement(
        'svg',
        { version: '1.1', viewBox: '0 0 25.5848 24.1156', width: '24px', height: '24px', role: 'img', className: classes, 'aria-label': a11yTitle },
