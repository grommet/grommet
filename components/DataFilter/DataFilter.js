...
var _excluded = ["children", "options", "property", "range"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
...
var DataFilter = exports.DataFilter = function DataFilter(_ref) {
  ...
  var _useMemo = (0, _react.useMemo)(function () {
      ...
      var maxDecimalPlaces = Math.max((0, _RangeSelector2.getDecimalCount)(uniqueValues[0]), (0, _RangeSelector2.getDecimalCount)(uniqueValues[uniqueValues.length - 1]));
  ...
  if (!content) {
    if (range) {
      ...
      if (!step) {
        ...
        if (step <= 0) {
          step = Math.pow(10, -(Math.max((0, _RangeSelector2.getDecimalCount)(range[0]), (0, _RangeSelector2.getDecimalCount)(range[1])) || 1));
        }
      }
