...
var _excluded = ["aria-label", "background", "color", "direction", "max", "messages", "size", "thickness", "type", "reverse", "value", "values"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
