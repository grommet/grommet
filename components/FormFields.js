...
var CLASS_ROOT = _CSSClassnames2.default.FORM_FIELDS; // (C) Copyright 2014-2015 Hewlett Packard Enterprise Development LP
...
var FormFields = function (_Component) {
  ...
  function FormFields() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FormFields).apply(this, arguments));
  }
