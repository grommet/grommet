...
var doc = function doc(FormField) {
  ...
  DocumentedFormField.propTypes = {
    component: _reactDesc.PropTypes.func.description("The component to insert in the FormField. Grommet will add update the form values when this field changes"),
