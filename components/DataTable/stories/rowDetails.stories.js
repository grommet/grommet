    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = "https://swapi.dev/api/starships?" + Object.keys(params).map(function (k) {
            return k + "=" + params[k];
          }).join('&');
...
var RowDetails = exports.RowDetails = function RowDetails() {
  ...
  var abortRef = (0, _react.useRef)();
  var _useState4 = (0, _react.useState)(['Y-wing']),
    expand = _useState4[0],
    setExpand = _useState4[1];
  (0, _react.useEffect)(function () {
    var _abortRef$current;
    // This API is a bit slow, abort any uncompleted requests.
    abortRef == null || (_abortRef$current = abortRef.current) == null || _abortRef$current.abort();
    abortRef.current = new AbortController();
    fetchData(view, abortRef.current.signal).then(function (_ref3) {
      ...
      if (results) {
        ...
        setTotal(function (prevTotal) {
          return Math.max(prevTotal, count);
        });
        setResult({
          data: results,
          filteredTotal: count
