...
var _excluded = ["background", "border", "column", "datum", "pad", "pin", "pinnedOffset", "primaryProperty", "scope", "verticalAlign"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
