...
var _excluded = ["cellProps", "columns", "fill", "footerValues", "groups", "onSelect", "pin", "pinnedOffset", "primaryProperty", "selected", "verticalAlign"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
