...
var _excluded = ["background", "border", "color", "font", "gap", "pad", "units"],
  _excluded2 = ["allowSelectAll", "cellProps", "columns", "data", "disabled", "fill", "filtering", "filters", "groupBy", "groups", "groupState", "messages", "onFilter", "onFiltering", "onResize", "onSelect", "onSort", "onToggle", "onWidths", "pin", "pinnedOffset", "primaryProperty", "selected", "rowDetails", "sort", "widths", "verticalAlign"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
  ...
  return /*#__PURE__*/_react["default"].createElement(_StyledDataTable.StyledDataTableHeader, _extends({
    ...
    var headerText = typeof header === 'string' ? header : function () {
      var _textFromNode = function textFromNode(node) {
        ...
        if (/*#__PURE__*/_react["default"].isValidElement(node)) return _textFromNode(node.props.children);
        return '';
      };
    ...
    if (onSort && sortable !== false) {
      ...
      content = /*#__PURE__*/_react["default"].createElement(StyledHeaderCellButton, _extends({
        ...
        "aria-hidden": true
      })), /*#__PURE__*/_react["default"].createElement(HiddenText, {
        id: sortStatusId,
        "aria-hidden": true
      }, format({
        id: hiddenTextId,
