...
var Tag = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return onRemove || !onClick ? /*#__PURE__*/_react["default"].createElement(_Box.Box, _extends({
    ...
    hoverIndicator: true,
    focusIndicator: true,
    icon: /*#__PURE__*/_react["default"].createElement(_FormClose.FormClose, (_theme$tag$size3 = theme.tag.size) == null || (_theme$tag$size3 = _theme$tag$size3[size]) == null ? void 0 : _theme$tag$size3.icon),
