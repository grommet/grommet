...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
...
var columns = [{
  ...
  render: function render(datum) {
    return /*#__PURE__*/_react["default"].createElement(_grommet.Box, {
      ...
      direction: "row",
      gap: "xsmall"
    }, datum.success ? /*#__PURE__*/_react["default"].createElement(_grommetIcons.StatusGoodSmall, {
      color: "status-ok"
    }) : /*#__PURE__*/_react["default"].createElement(_grommetIcons.StatusCriticalSmall, {
      color: "status-critical"
    }), /*#__PURE__*/_react["default"].createElement(_grommet.Text, null, datum.success ? 'Successful' : 'Failed'));
  }
}];
var STEP = 10;
var Table = exports.Table = function Table() {
  ...
  var _useState4 = (0, _react.useState)(STEP),
    limit = _useState4[0],
