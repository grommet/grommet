...
Object.keys(_DataTableGroupBy).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _DataTableGroupBy[key]) return;
  exports[key] = _DataTableGroupBy[key];
});
