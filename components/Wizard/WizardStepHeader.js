...
var WizardStepHeader = exports.WizardStepHeader = function WizardStepHeader(_ref) {
  var _theme$wizard, _theme$wizard2, _messages$stepHeader;
  ...
  var counterTemplate = (messages == null || (_messages$stepHeader = messages.stepHeader) == null ? void 0 : _messages$stepHeader.counter) || format({
