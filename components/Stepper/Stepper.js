...
var Stepper = exports.Stepper = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var stepperContent = /*#__PURE__*/_react["default"].createElement(_Box.Box, _extends({
    ...
    overflow: "hidden",
    gap: {
      row: (_theme$stepper = theme.stepper) == null || (_theme$stepper = _theme$stepper.horizontal) == null ? void 0 : _theme$stepper.gap,
      column: (_theme$stepper2 = theme.stepper) == null || (_theme$stepper2 = _theme$stepper2.vertical) == null ? void 0 : _theme$stepper2.gap
    },
    pad: "none",
    margin: "none",
    style: {
