...
var StyledIndicator = exports.StyledIndicator = _styledComponents["default"].span.withConfig(_utils.styledComponentsConfig).withConfig({
  ...
  var _theme$stepper3, _stateTheme$hover, _stateTheme$hover2, _stateTheme$hover3, _theme$stepper4, _theme$stepper5, _theme$stepper6;
  ...
  var defaultColorHoverColor = color ? "color-mix(in srgb, " + color + " 80%, black)" : (0, _utils.normalizeColor)(((_theme$stepper6 = theme.stepper) == null || (_theme$stepper6 = _theme$stepper6.hover) == null ? void 0 : _theme$stepper6.color) || 'text-strong', theme);
...
var StyledConnector = exports.StyledConnector = _styledComponents["default"].span.withConfig(_utils.styledComponentsConfig).withConfig({
  ...
  var _theme$stepper7, _theme$stepper8, _theme$global3, _theme$stepper9, _theme$global4, _theme$global5;
  var theme = props.theme;
  var indicatorSizeToken = ((_theme$stepper7 = theme.stepper) == null || (_theme$stepper7 = _theme$stepper7.indicator) == null ? void 0 : _theme$stepper7.size) || 'medium';
  var parentSize = getMetricSize(theme, indicatorSizeToken);
  var indicatorBorderWidth = getMetricSize(theme, ((_theme$stepper8 = theme.stepper) == null || (_theme$stepper8 = _theme$stepper8.indicator) == null || (_theme$stepper8 = _theme$stepper8.border) == null ? void 0 : _theme$stepper8.width) || '2px');
  ...
  var connectorThickness = ((_theme$stepper9 = theme.stepper) == null || (_theme$stepper9 = _theme$stepper9.connector) == null || (_theme$stepper9 = _theme$stepper9.stroke) == null ? void 0 : _theme$stepper9.width) || ((_theme$global4 = theme.global) == null || (_theme$global4 = _theme$global4.borderSize) == null ? void 0 : _theme$global4.small) || '2px';
