...
var _excluded = ["a11yTitle", "aria-label", "numberItems", "numberEdgePages", "numberMiddlePages", "onChange", "messages", "page", "size", "step", "stepOptions", "summary"]; // SPDX-FileCopyrightText: © Hewlett Packard Enterprise Development LP
