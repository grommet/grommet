...
export type BoxSideType = "top" | "left" | "bottom" | "right" | "horizontal" | "vertical" | "all";
export type BoxSizeType = "xsmall" | "small" | "medium" | "large" | "xlarge" | string;
export type BoxStyleType = "solid" | "dashed" | "dotted" | "double" | "groove" | "ridge" | "inset" | "outset" | "hidden";
