...
if (process.env.NODE_ENV !== 'production') {
  PropType = {
    ...
    messages: PropTypes.shape({
      ...
      // sentence for sorted columns (e.g. "sorted ascending, activate to
      // sort descending"), as of the #7924 accessibility fix. `sortable`
      // covers the unsorted-but-sortable state.
