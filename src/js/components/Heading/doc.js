...
export const themeDoc = {
  ...
  'heading.level': {
    description: `The level that impacts line height, max width, font size, weight and 
      family of the Heading.`,
    type: 'object',
    defaultValue: `
      1: {
        medium: {
  ...
  'heading.responsiveBreakpoint': {
    description: `The breakpoint to trigger changes in the Heading layout. The actual 
