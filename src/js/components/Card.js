...
export default class Card extends Component {
  ...
  render () {
    const { children, className, colorIndex, contentPad, details, direction,
      heading, headingStrong, label, onClick, pad, reverse, summary, textSize,
      thumbnail, video } = this.props;
