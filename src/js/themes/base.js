    ...
    clock: {
      ...
      digital: {
        ...
        text: {
          ...
          small: { size: `${baseFontSize - fontScale}px`, height: 1.4375 },
          medium: { size: `${baseFontSize}px`, height: 1.375 },
          large: { size: `${baseFontSize + fontScale}px`, height: 1.3125 },
          xlarge: { size: `${baseFontSize + 2 * fontScale}px`, height: 1.25 },
